...
hittable_list random_scene() {
    ...
    world.add(make_shared<sphere>(point3(4, 1, 0), -0.95, material1));

    auto material2 = make_shared<lambertian>(color(1, 0, 0.4));
...
#pragma omp parallel for default(none) shared(png, cam, world)
